...
import com.mycompany.app_os.Administrador;
...
public class Frame_login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        BT_entrar.setMaximumSize(new java.awt.Dimension(50000, 50000));
        BT_entrar.setPreferredSize(new java.awt.Dimension(400, 100));
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(BT_entrar, javax.swing.GroupLayout.DEFAULT_SIZE, 252, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void BT_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BT_loginActionPerformed
        ...
        if(login.equals(adm.getLogin()) && senha.equals(adm.getSenha())){
            ...
            Controller.listaProduto = new ArrayList<>();
